...
<?php
   ...
   if (isset($_POST["add"])){
	   if (isset($_SESSION["cart1"])){
            $item_array_id = array_column($_SESSION["cart1"],"books_id");
			if (!in_array($_GET["books_id"],$item_array_id)){
	 ...
	 if (isset($_GET["action"])){
        if ($_GET["action"] == "delete"){
            foreach ($_SESSION["cart1"] as $keys => $value){
                if ($value["product_id"] == $_GET["books_id"]){
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="cart1.php?action=add&bookid=<?php echo $row["bookid"]; ?>">

                            <div class="product">
                                <img src="<?php echo $row["bookimg"]; ?>" class="img-responsive">
                                <h5 class="text-info"><?php echo $row["bookname"]; ?></h5>
                                <h5 class="text-danger"><?php echo $row["bookprice"]; ?></h5>
                ...
                if(!empty($_SESSION["cart1"])){
                    ...
                    foreach ($_SESSION["cart1"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="cart1.php?action=delete&books_id=<?php echo $value["product_id"]; ?>"><span
